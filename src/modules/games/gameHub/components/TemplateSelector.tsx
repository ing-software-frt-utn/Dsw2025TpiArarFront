            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden animate-in zoom-in duration-200">
                ...
                <div className="p-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 bg-gray-50">
                    ...
                    >
                        ...
                        <p className="text-gray-500 text-sm">Carga pares de cartas para entrenar la memoria de tus alumnos.</p>
                    </div>
                    ...
                    >
                        ...
                        <p className="text-gray-500 text-sm">Crea una lista de palabras con pistas desde el banco de datos.</p>
                    </div>
