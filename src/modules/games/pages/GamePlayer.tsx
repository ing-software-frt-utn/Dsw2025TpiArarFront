...
const GameView = () => {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-gray-900 text-white relative font-sans overflow-hidden">
      ...
      <div className="flex justify-between items-center p-4 bg-gray-800 border-b border-gray-700 w-full shrink-0">
      ...
      <div className="flex-1 flex items-center justify-center bg-gray-700 m-2 sm:m-4 rounded-3xl border-4 border-gray-500 relative overflow-hidden">
        <div className="w-full h-full flex justify-center items-center">
            {Number(gameId) === 1 && <Memotest />}
            {Number(gameId) === 2 && <Ahorcadito />}
            {Number(gameId) === 3 && <Trivia />}
        </div>
      </div>

      {showExitConfirm && (
        <div className="absolute inset-0 z-[999] flex items-center justify-center bg-black/80 backdrop-blur-md p-4">
